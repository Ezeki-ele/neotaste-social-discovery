...
export default function DiscoverScreen({ onOpenRestaurant, activeTab, onTabChange }: Props) {
  ...
  const filters = ['Now', 'Cuisine', 'Sort'];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#fff' }}>
      ...
      <div style={{ padding: '12px 16px 8px' }}>
        <div style={{
          ...
          background: '#f5f5f5', borderRadius: '12px', padding: '11px 14px',
        }}>
          ...
          <span style={{ fontSize: '14px', color: '#737373', fontFamily: 'Poppins, system-ui' }}>
            Search deals &amp; more
          </span>
        </div>
      </div>
      ...
      <div style={{ padding: '4px 16px 10px', display: 'flex', gap: '8px', overflowX: 'auto', scrollbarWidth: 'none' }}>
        ...
        <button
          ...
          style={{
            display: 'flex', alignItems: 'center', gap: '5px',
            background: activeFilter === 'Now' ? '#53f293' : '#f5f5f5',
        ...
        <button
          ...
          style={{
            display: 'flex', alignItems: 'center', gap: '5px',
            background: activeFilter === 'Cuisine' ? '#53f293' : '#f5f5f5',
            border: 'none', borderRadius: '20px',
            padding: '7px 12px', cursor: 'pointer', flexShrink: 0,
          }}>
      ...
      {view === 'list' ? (
        <>
          ...
          {activeFilter === 'Cuisine' && (
            <div style={{ padding: '4px 16px 8px' }}>
              <span style={{ fontSize: '14px', fontWeight: 700, color: '#0a0a0a', fontFamily: 'Poppins, system-ui' }}>
                14 results
              </span>
            </div>
          )}
            ...
            {restaurants.map((r, i) => (
              <button
                ...
                style={{
                  ...
                  borderBottom: i < restaurants.length - 1 ? '1px solid rgba(28,29,40,0.08)' : 'none',
                  textAlign: 'left',
              ...
              >
                {/* Food image */}
                <div style={{
                  width: 76, height: 76, borderRadius: '10px', flexShrink: 0,
                  ...
                  {r.isNew && (
                    <div style={{
                      ...
                      background: '#fff592', borderRadius: '4px', padding: '1px 6px',
                    }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{
                    ...
                    marginBottom: '2px', fontFamily: 'Poppins, system-ui',
                    whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
                  }}>
                    {r.name}
                  </p>
                  <p style={{ fontSize: '12px', color: '#737373', marginBottom: '4px', fontFamily: 'Poppins, system-ui' }}>
                    {r.cuisine}
                  </p>
                  ...
                  <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap', alignItems: 'center' }}>
                    {r.deals.slice(0, 2).map((d, di) => (
                      <span key={d.id} style={{
                        background: '#53f293', color: '#08180f',
                        fontSize: '11px', fontWeight: 600,
                        padding: '3px 8px', borderRadius: '4px',
                        fontFamily: 'Poppins, system-ui', flexShrink: 0,
                      }}>
                        {d.title}
                      </span>
                    ))}
        ...
        <div style={{
          flex: 1,
          background: 'linear-gradient(135deg, #d4e8d0 0%, #c8dfc4 50%, #b8d4b3 100%)',
          position: 'relative',
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: '12px', color: '#737373', marginBottom: '5px', fontFamily: 'Poppins, system-ui' }}>
                Frühstück, Café · 4,5 km
              </p>
              <SocialSignal signal={{ type: 'friend', text: 'Jack besucht · letzte Woche' }} />
            </div>
      ...
      <div style={{ position: 'relative' }}>
        <div style={{
          position: 'absolute', bottom: view === 'list' ? '80px' : '16px', left: '50%',
          ...
          <button
            ...
            style={{
              background: '#11301d', color: '#fff',
              border: 'none', borderRadius: '20px',
              padding: '10px 20px',
              display: 'flex', alignItems: 'center', gap: '6px',
              cursor: 'pointer', boxShadow: '0 4px 16px rgba(0,0,0,0.25)',
              fontSize: '13px', fontWeight: 600, fontFamily: 'Poppins, system-ui',
            }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
